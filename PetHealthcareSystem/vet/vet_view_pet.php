            ...
            <table class="pet-display-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="action-btn" style="padding: 10px;" onclick="window.location.href='vet_pet_vaccine.php?id=<?php echo $row['pet_id']; ?>'">View Vaccine Record</button>
                            <button class="action-btn" style="padding: 10px; margin-top: 5px;" onclick="window.location.href='vet_view_medical.php?id=<?php echo $row['pet_id']; ?>&user=<?php echo $row['user_id']; ?>'">View Medical Records</button>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
            <button class="action-btn" style="margin-top: 20px; font-size: 20px; padding: 10px;" onclick="window.location.href='vet_vaccine.php'">Back</button>
        </div>
    </div>
</body>
</html>
